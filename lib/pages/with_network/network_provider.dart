...
class NetworkStatus with ChangeNotifier {
  ...
  Future<List<QuestionModel>> generateContentWithGemini() async {
    const apiKey = 'AIzaSyApok7zDqvuWsk6Ok9y7Zd7O3XtBTZc-L8'; // API k
    const url =
      ...
      "contents": [
        {
          "parts": [
            {
              "text": """
$selectedLanguage tiliga oid 20 ta murakkab test savollarini tuzing. Har bir savol quyidagi JSON formatda bo‘lsin:
